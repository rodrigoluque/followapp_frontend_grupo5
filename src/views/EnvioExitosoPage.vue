<template>
    ...
    <ion-page id="main-content" class="white-bg">
      ...
      <ion-content color="light">
        ...
        <ion-text class="texto"> ¡Ya te enviamos el reporte!</ion-text>
        <br><br>
        <div class="btn-wrapper">
          <ion-button color="warning"  fill="clear"  @click="medicamentos"><Icon  icon="carbon:next-filled" width="70"></Icon></ion-button>
          </div>   
