<template>
    ...
    <ion-page id="main-content" class="white-bg">
      ...
      <ion-content color="light">
        ...
        <ion-text class="texto"> ¿Comó querés compartir el informe?</ion-text>
        <br><br><br><br>
        <div class="btn-wrapper">
          <ion-button   fill="clear" @click="envioexitoso"><Icon  icon="fluent-emoji-flat:e-mail" width="70"></Icon></ion-button>
          <ion-button   fill="clear" @click="envioexitoso"><Icon  icon="logos:whatsapp-icon" width="70"></Icon></ion-button>
          <ion-button   fill="clear" @click="envioexitoso"><Icon  icon="vscode-icons:file-type-pdf2" width="70"></Icon></ion-button>
          </div>  
