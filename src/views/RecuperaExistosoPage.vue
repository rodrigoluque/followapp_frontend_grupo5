    ...
    <ion-page id="main-content" class="white-bg">
      <ion-header>
        <ion-toolbar>
          ...
          <center><h4>  RECUPERA TU CONTRASEÑA</h4></center>
          </ion-toolbar>
      </ion-header>  
      <ion-content color="light">
        ...
        <ion-text class="texto"> ¡La clave ha sido actualizada!</ion-text><br><br><br><br>
          <ion-text class="texto"> ¡Volvé a iniciar sesión!</ion-text>
        <br><br>
        <div class="btn-wrapper">
        <ion-button  color="warning" fill="clear"  @click="login"><Icon  icon="carbon:next-filled" width="70"></Icon></ion-button>
        </div>       
     ...
     <ion-footer>
      <ion-toolbar >   
       ...
       <div class="btn-wrapper">
        <ion-button    @click="logout"><Icon  icon="ri:logout-box-r-fill" width="30"></Icon></ion-button>
       </div>
