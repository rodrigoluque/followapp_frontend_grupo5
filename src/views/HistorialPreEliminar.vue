<template>
      ...
      <ion-page id="main-content" class="white-bg">
        ...
        <ion-content color="light">
          ...
          <ion-text class="texto"> ¿Esta seguro que deseas eliminar tu afección?</ion-text>
          <br><br><br><br>

          <div class="btn-wrapper">
            <ion-button  color="warning" fill="clear"  @click="historialeliminar"><Icon  icon="game-icons:confirmed" width="70"></Icon></ion-button>
            <ion-button  color="warning" fill="clear"  @click="historial"><Icon  icon="ic:round-cancel" width="75"></Icon></ion-button>
            </div> 
