<template>
    ...
    <ion-page id="main-content" class="white-bg">
      ...
      <ion-content color="light">
        ...
        <ion-text class="texto"> ¡Tu afección a sido editada con exito!</ion-text>
        <br><br><br><br>
        <div class="btn-wrapper">
          <ion-button  color="warning" fill="clear"  @click="historial"><Icon  icon="carbon:next-filled" width="70"></Icon></ion-button>
          </div>   
    ...
    <script>
      ...
      eventos(){
        ...
        this.$router.push('/login');
			      ...
			      historialeditada(){
        this.$router.push('/historialeditada');
